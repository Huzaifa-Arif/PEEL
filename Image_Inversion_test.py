...
def invert(image, network='alexnet', size=224, layer='features.4',activation = None, alpha=6, beta=2, 
    ...
    for i in range(epochs):
        #
        cts = get_acts(model, x_) ### Activations
        #import pdb;pdb.set_trace()
        features = model(x_)
        
        acts = features[0]['conv']
...
#                 default='/Users/huzaifaarif/Desktop/IBM_2023_new/Cat2.png')
...
#         invert(image=args.image, network=args.network, layer=args.layer, activation = args.activation,
